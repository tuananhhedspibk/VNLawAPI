class Api::V1::DepositesController < ApplicationController
  def index
    ...
    deposite.done = false
    deposite.amount = (params[:amount].to_i)
    deposite.save
